...
# Download server.jar for 1.21.1 if it doesn't exist
if [ ! -f server.jar ]; then
    curl -o server.jar https://api.papermc.io/v2/projects/paper/versions/1.21.1/builds/85/downloads/paper-1.21.1-85.jar
fi
...
# Start the server with 3156 MB of RAM
